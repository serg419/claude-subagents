...
description: "Develops and fixes the UI layer — HTML templates, CSS, JavaScript, forms, tables, modals, dropdowns. Also handles view templates and frontend controllers."
model: sonnet
color: yellow
---
