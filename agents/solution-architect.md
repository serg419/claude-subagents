...
description: "Plans implementation of new features, designs class structures, makes architectural decisions. Focuses on WHAT and WHY, not HOW. Use before any significant development effort — new features, refactors, pattern choices, integration design."
model: opus
color: purple
---
